...
# Je saute l'appel à l'API, je vais récuperer direct les images des pokemons c'est moins lourd mais du coup je ne récupère pas leurs noms et j'en aurais eu besoin pour faire des hyper lien vers pokepedia
#
...
def get_pokemon_data(idPokemon): #2.2 #fais l'appel à l'API pour récupérer les images des pokemons
    ...
    url = f"https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/{idPokemon}.png" 
    images_pokemon.append(url)  # Ajout de l'URL à la liste globale
